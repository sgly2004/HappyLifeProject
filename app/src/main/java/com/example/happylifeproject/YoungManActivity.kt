...
class YoungManActivity : AppCompatActivity() {
    private var datas = mutableListOf<Item_card>()
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_young_man)
        ...
        val adapter = YoungManAdapter(this,datas)
